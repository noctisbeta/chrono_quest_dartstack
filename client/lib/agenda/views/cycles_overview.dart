...
class CyclesOverview extends StatelessWidget {
        ...
        child: BlocBuilder<AgendaBloc, AgendaState>(
          builder: (context, state) {
            final List<Cycle> cycles = switch (state) {
              AgendaStateCyclesLoaded(:final List<Cycle> cycles) => cycles,
              _ => [],
            };

            final DateTime? referenceDate = switch (state) {
              AgendaStateNoCyclesLoaded(:final DateTime referenceDate) =>
                referenceDate,
              AgendaStateCyclesLoaded(:final DateTime? referenceDate) =>
                referenceDate,
              _ => null,
            };
    ...
    child: Column(
      ...
      children: [
        ...
        MyElevatedButton(
          ...
          trailing: const Icon(Icons.calendar_today, size: 20, color: kWhite),
          onPressed: () async {
    ...
    child: Column(
      ...
      children: [
        ...
        MyElevatedButton(
          ...
          backgroundColor: kQuaternaryColor,
          trailing: const Icon(Icons.add, size: 20, color: kWhite),
          onPressed: () {
  ...
  Column _buildCyclesNotEmptyView(
    List<Cycle> cycles,
    ...
    children: [
      Expanded(
        child: CustomPaint(
          painter: CyclesPainter(cycles: cycles),
          ...
          children: [
            Expanded(
              child: ListView.builder(
                ...
                itemCount: cycles.map((c) => c.period).toSet().toList().length,
                itemBuilder: (context, horizontalIndex) {
                  final List<Cycle> sortedCycles =
                      cycles..sort((a, b) => a.period.compareTo(b.period));
